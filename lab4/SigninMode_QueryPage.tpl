	...
	<body>
		<div>
			<div class = "background">
				<div> <a href="/signinMode"><img src="/static/switch_pokemonletsgopikachu_logo.png" class = "title"></div></a>

				<div class = "displayBlock">
					<p>Search for: "{{SearchingTerm}}"<p>
						<table id ="results"  cellspacing = "1px" >		
							<tr>
								<td><b>Word <br> </b></td>
								<td><b>Count</b></td>
							</tr>
						...
						<p>Top 10 Keywords Searched</p>
						
						<table id ="history" cellspacing = "1px" >
							<tr>
								<td><b>Word <br> </b></td>
								<td><b>Count</b></td>
							</tr>
				...
				<form action = "/logout" >	
				<div><input value="logout" type="submit" class = "loginbar"></div>
				</form>		
